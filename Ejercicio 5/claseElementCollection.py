...
def main():
    ...
    my_collection.insert_element(12, 0)
    my_collection.agregar_element(22)
    elemento = my_collection.mostrar_element(0)  # Obtiene el elemento en la posicion 1 
    print(elemento)  # Imprimes el elemento en la consola
